...
function Hero() {
  return (
    <div className='flex flex-col justify-center items-center my-20'>
        ...
        <h2 className='font-bold text-[60px] text-slate-700'>Meeting scheduling made easy.</h2>
        <h2 className='text-xl mt-5 text-slate-500'>Meetify is your scheduling automation platform for eliminating the back-and-forth emails.</h2>
